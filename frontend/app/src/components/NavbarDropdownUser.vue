...
<template>
  <div v-if="user">
    <Menu as="div" class="">
      <div>
        <MenuButton class="flex items-center pr-3 text-sm transition duration-150 ease-in-out bg-gray-800 border-2 border-gray-700 rounded-full focus:outline-none focus:shadow-solid">
